...
var liffId = "1657153526-9VPnAZdy",
...
function initLiff(id) {
    console.log("Going to initialize LIFF to", id),
    liff.init({
        liffId: id
    }).then(() => {
        ...
        console.error("LIFF initialization failed", id)
    })
}
function initApp() {
...
function initContent(a) {
    ...
    (
        ...
        d.placeholder = "Text message", 
        d.required = !0, 
        getParameterByName("packageId") && (d.value = getParameterByName("packageId")), 
        e.htmlFor = "packageId", 
        e.innerHTML = "貼圖包編號", 
        c.appendChild(d), 
        c.appendChild(e), 
        g.insertBefore(c, g.childNodes[4]), c = document.createElement("div"), 
        d = document.createElement("input"), 
        e = document.createElement("label"), 
        c.className = "form-label-group", 
        c.id = "data", 
        ...
        d.required = !0, 
        getParameterByName("stickerId") && (d.value = getParameterByName("stickerId")), 
        e.htmlFor = "stickerId", 
        e.innerHTML = "貼圖編號", 
        c.appendChild(d), 
        c.appendChild(e), 
    ...
    (
        c.className = "form-label-group", 
        c.id = "data", d.type = "text", 
        d.id = "downloadUrl", 
        d.className = "form-control", 
        d.placeholder = "Original content url", 
        d.required = !0, 
        getParameterByName("downloadUrl") && (d.value = getParameterByName("downloadUrl")),
        ...
        d.placeholder = "Preview image url", 
        d.required = !0, 
        getParameterByName("previewUrl") && (d.value = getParameterByName("previewUrl")), 
    ...
    (
        ...
        f.rows = "5", getParameterByName("messages") && (f.value = getParameterByName("messages")),
        c.appendChild(f),
        g.insertBefore(c, g.childNodes[4])
    ) : "messagesUrl" == a ? 
    (
        ...
        d.required = !0,
        getParameterByName("messagesUrl") && (d.value = getParameterByName("messagesUrl")),
    ...
    (
        ...
        d.required = !0,
        getParameterByName("lineAuthKey") && (d.value = getParameterByName("lineAuthKey")),
...
function sendLiffMessage() {
    var a = document.getElementById("type").value,
        b = new HttpClient,
        c = "Unknown",
        d = "https://i.imgur.com/6DmTQk6.png",
        e = "";
    if (liff.getProfile().then(a => {
        c = a.displayName,
        d = a.pictureUrl,
        e = a.statusMessage
    }).catch(a => {
        ...
        sendMessages([{
            ...
            contents: {
                ...
                hero: {
                    ...
                    action: {
                        type: "uri",
                        uri: "line://app/1657024923-2r46WKKN?auto=yes&type=image&downloadUrl=" + d + "&previewUrl=" + d
                    }
                },
                body: {
                    type: "box",
                ...
                footer: {
                    ...
                    contents: [{
                        ...
                        action: {
                            type: "uri",
                            label: "Profile",
                            uri: "line://app/1657024923-2r46WKKN?auto=yes&type=profile"
                        }
                    }, {
                        type: "spacer",
                        size: "sm"
...
function sendMessages(a) {
    liff.isInClient() ? !0 == document.getElementById("share").checked ? (console.info("Start initializing share message"), liff.isApiAvailable("shareTargetPicker") && liff.shareTargetPicker(a).then(() => {
        console.log("Share message was launched")
    }).catch(a => {
        console.error("Share message failed", a)
    })) : (console.info("Start sending message"), liff.sendMessages(a).then(() => {
...
function scanCodeQr() {
    liff.isInClient() ? (console.info("Start scan code qr"), liff.scanCode().then(a => {
...
function getParameterByName(a) {
    var b = null;
    return a = a.replace(/[\[\]]/g, "\\$&"), params[a] && (b = unescape(params[a])), b
}
