...
function initContent(a) {
    ...
    a || (a = getParameterByName("type"), a && (document.getElementById("type").value = a), 0 >= document.getElementById("type").selectedIndex && (document.getElementById("type").value = "choose"), b = !1),
